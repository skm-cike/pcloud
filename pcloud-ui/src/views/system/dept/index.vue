    ...
    <el-table
      ...
      <el-table-column prop="deptName" label="部门名称" width="200" >
        <!-- <template slot-scope="scope">
          <span v-if="(!scope.row.children || scope.row.children.length==0) && scope.row.parentId==0" class="el-table__placeholder" style="width:23px"></span>
          {{ scope.row.deptName }}
        </template> -->
      </el-table-column>
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
         ...
         <el-form-item label="备注" prop="remark">
          <el-input class="text" type="textarea" v-model="form.remark" placeholder="请输入备注" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    deptNameFormat(row,colume,cellValue,index){
      console.log("row:"+row);
      console.log("colume:"+colume);
