  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
      <el-form-item label="所属机构" prop="orgId">
       ...
       <el-form-item label="申领状态" prop="orgId">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['bankbox:outputProcess:add']"
        >申领</el-button>
      </el-col>
      <!-- <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['bankbox:outputProcess:edit']"
        >修改</el-button>
      </el-col> -->
      <!-- <el-col :span="1.5">
        <el-button
      ...
      <!-- <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['bankbox:outputProcess:export']"
        >导出</el-button>
      </el-col> -->
    </el-row>
    ...
    <el-table v-loading="loading" :data="processList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="申领结果" align="center" prop="result" />
      <el-table-column label="申领状态" align="center" :formatter="statusFormat" />
      <el-table-column label="计划取箱人" align="center" :formatter="planOutputUser" />
      ...
      <div style="display:inline-block;" v-if="scope.row.status=='3'">
          <el-button
            ...
            v-hasPermi="['bankbox:outputProcess:reApply']"
          >重新申领</el-button>
      </div>
      <div style="display:inline-block;" v-if="scope.row.toReviewUser&&(scope.row.result=='' || scope.row.result==null)">
          <el-button
            ...
            v-hasPermi="['bankbox:outputProcess:recheck']"
          >复核</el-button>
      </div>
      <div style="display:inline-block;" v-if="scope.row.toApprovalUser">
          <el-button
            ...
            icon="el-icon-edit"
            @click="handleRec(scope.row)"
            v-hasPermi="['bankbox:outputProcess:approve']"
          >审批</el-button>
      </div>
      <div style="display:inline-block;" v-if="scope.row.toApplyUserId">
          <el-button
      ...
      <div style="display:inline-block;">
          <el-button
            ...
            v-hasPermi="['bankbox:outputProcess:query']"
          >查看</el-button>
      </div>
        </template>
      </el-table-column>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="钞箱：" prop="cashboxs">
              <el-select v-model="form.cashboxs" multiple placeholder="请选择" clearable>
                <el-option
          ...
          <!-- <el-col :span="12">
            <el-form-item label="钞箱数量" prop="quantity">
              <el-input v-model="form.quantity" style="width:200px" placeholder="请输入钞箱数量" />
            </el-form-item>
          </el-col>-->

          <el-col :span="12">
            <el-form-item label="复核人员" prop="reviewUserId">
              <el-select v-model="form.reviewUserId" clearable placeholder="请选择">
                <el-option
                  v-for="item in reviewUserOptions"
                  :key="item.userId"
                  :label="item.nickName"
          ...
          <el-date-picker clearable size="small" style="width: 200px"
            ...
            <el-form-item label="审批人员" prop="approvalUserId">
              <el-select v-model="form.approvalUserId" clearable placeholder="请选择">
                <el-option
                  v-for="item in reviewUserOptions"
                  :key="item.userId"
                  :label="item.nickName"
          ...
          <el-date-picker clearable size="small" style="width: 200px"
            ...
            <el-form-item label="申领状态">
              <el-select v-model="form.status" disabled placeholder="请选择状态" clearable>
                <el-option
                  v-for="dict in statusOptions"
                  :key="dict.dictValue"
                  :label="dict.dictLabel"
          ...
          <el-input v-model="form.pid" placeholder="请输入父流程id" />
            ...
            <el-form-item label="计划取箱人" prop="planOutputUserId">
              <el-select v-model="form.planOutputUserId" disabled clearable placeholder="请选择">
                <el-option
                  v-for="item in reviewUserOptions"
                  :key="item.userId"
                  :label="item.nickName"
          ...
          <el-col :span="12">
            <el-form-item label="计划取箱时间" prop="planOutputTime">
              <el-date-picker
                clearable
                style="width: 200px"
                v-model="form.planOutputTime"
                type="datetime"
                value-format="yyyy-MM-dd HH:mm:ss"
                placeholder="选择计划取箱人"
              ></el-date-picker>
         ...
         <el-form-item label="申领结果：" prop="result">
    ...
    <!-- 查看详情 -->
    <el-dialog :title="title" :visible.sync="openView" width="1000px">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="所属机构："  prop="orgId">
          ...
          <el-col :span="12">
            <el-form-item label="申请人员：" prop="applyUserId">
              <el-select v-model="form.applyUserId" disabled clearable >
                <el-option
                  v-for="item in reviewUserOptions"
                  :key="item.userId"
                  :label="item.nickName"
          ...
          <el-col :span="12">
            <el-form-item label="钞箱数量：" prop="quantity">
              <el-input v-model="form.quantity" disabled style="width:200px"/>
            </el-form-item>
          </el-col>

          <el-col :span="12">
            <el-form-item label="复核人员："  prop="reviewUserId">
              <el-select v-model="form.reviewUserId" disabled clearable>
                <el-option
                  v-for="item in reviewUserOptions"
                  :key="item.userId"
                  :label="item.nickName"
          ...
          <el-col :span="12">
            <el-form-item label="复核日期：" disabled prop="reviewDatatime">
          ...
          <el-col :span="12">
            <el-form-item label="审批人员：" prop="approvalUserId">
              <el-select v-model="form.approvalUserId" disabled  clearable >
                <el-option
                  v-for="item in reviewUserOptions"
                  :key="item.userId"
                  :label="item.nickName"
          ...
          <el-col :span="12">
            <el-form-item label="审批日期：" disabled prop="approvalDatatime">
            <el-date-picker clearable style="width: 200px"
            v-model="form.approvalDatatime"
            type="datetime"
            disabled
          ...
          <el-input v-model="form.pid" placeholder="请输入父流程id" />
            ...
            <el-form-item label="计划取箱人：" prop="planOutputUserId">
              <el-select v-model="form.planOutputUserId" disabled clearable>
                <el-option
                  v-for="item in reviewUserOptions"
                  :key="item.userId"
                  :label="item.nickName"
    ...
    <!-- 复核、审批 -->
    <el-dialog :title="title" :visible.sync="openRec" width="1000px">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="所属机构："  prop="orgId">
...
import {
  ...
  passProcess,
  getdeptAndUser
} from "@/api/bankbox/outputProcess";
  ...
  data() {
    return {
      ...
      queryParams: {
        ...
        status: undefined,
        pid: undefined,
        planOutputUserId: undefined,
        planOutputTime: undefined,
      ...
      rules: {
        ...
        cashboxs: [
          { required: true, message: "尾箱不能为空", trigger: "blur" }
        ],  
        applyDatatime: [
          { required: true, message: "申请时间不能为空", trigger: "blur" }
        ],  
        planOutputTime: [
          { required: true, message: "计划取箱时间不能为空", trigger: "blur" }
        ],  
        planOutputUserId: [
          { required: true, message: "计划取箱人不能为空", trigger: "blur" }
        ]
      }
    };
  },
...
reviewUser(row, column) {
    ...
    planOutputUser(row, column) {
      var actions = [];
      Object.keys(this.reviewUserOptions).map(key => {
        if (this.reviewUserOptions[key].userId == "" + row.planOutputUserId) { 
          actions.push(this.reviewUserOptions[key].nickName);
          return false;
        }
      });
    ...
    //     getDeviceList(val).then(response => {
    //       //给尾箱柜下拉框赋值
    ...
    selectBoxByDeviceId(val) {
      ...
      this.form.cashboxs="";
      if (val != null && val != "" && val != undefined) {
        getBoxList(val,"0").then(response => {
          //给尾箱柜下拉框赋值
 ...
 console.log(this.loginUser)
    ...
    handleSelectionChange(selection) {
      this.ids = selection.map(item => item.outputProcessId);
    ...
    handleAdd() {
      ...
      getdeptAndUser().then(response =>{
        ...
        this.form.planOutputUserId=response.applyUser.userId;
    ...
    handleUpdate(row) {
      this.reset();
      const outputProcessId = row.outputProcessId || this.ids;
      getProcess(outputProcessId).then(response => {
    ...
    handleRec(row){
     ...
     submitFormback: function() {
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.outputProcessId != undefined&&(this.form.result!=='' && this.form.result!==null)) {
    ...
    submitForm: function() {
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.outputProcessId != undefined&&!this.isReApply) {
          ...
          }else if (this.form.outputProcessId != undefined&&this.isReApply){
            reApplyProcess(this.form).then(response => {
              if (response.code === 200) {
                this.msgSuccess("重建申领成功");
                this.open = false;
                this.openRec = false;
                this.getList();
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      const outputProcessIds = row.outputProcessId || this.ids;
      this.$confirm(
        '是否确认删除该申领流程的数据?',
        "警告",
        {
        ...
        .then(function() {
          return delProcess(outputProcessIds);
        })
        .then(() => {
          this.getList();
    ...
    handleExport() {
      ...
      this.$confirm("是否确认导出所有申领流程数据项?", "警告", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning"
      })
